...
#ifndef RNGBLE_SWIFT_H
#define RNGBLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RNGBLE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC6RNGBLE15BLEBatteryModel")
@interface BLEBatteryModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6RNGBLE18BLEControllerModel")
@interface BLEControllerModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6RNGBLE16BLEInverterModel")
@interface BLEInverterModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC6RNGBLE13RNGBLEManager")
@interface RNGBLEManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface RNGBLEManager (SWIFT_EXTENSION(RNGBLE)) <CBPeripheralDelegate>
...
@interface RNGBLEManager (SWIFT_EXTENSION(RNGBLE)) <CBCentralManagerDelegate>
...
/// The manager invokes this method when disconnecting a peripheral previously connected with the connect(<em>:options:) method. The error parameter contains the reason for the disconnection, unless the disconnect resulted from a call to cancelPeripheralConnection(</em>:). After this method executes, the peripheral device’s CBPeripheralDelegate object receives no further method calls.
